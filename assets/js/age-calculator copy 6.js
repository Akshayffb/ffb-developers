...
$(document).ready(function () {
  ...
  function displayAge() {
    ...
    function updateLive() {
      ...
      // calculate total units dynamically every tick
    ...
    <div class="age-result">
      <p><strong>You are:</strong> ${age.years} years ${age.months} months ${
        age.days
      } days 
          ${ageDiff.hours} hours ${ageDiff.minutes} minutes</p>

      <p><strong>You were born on:</strong> 
